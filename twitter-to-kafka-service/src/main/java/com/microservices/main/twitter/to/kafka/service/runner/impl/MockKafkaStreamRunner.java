...
import com.microservices.main.twitter.to.kafka.service.exception.TwitterToKafkaServiceException;
...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    private static final String[] WORDS = new String[]{
            "Lorem", "psum", "dolor", "sit", "amet", "consectetur", "adipiscing", "elit", "In", "vel", "sagittis", "turpis", "a rutrum", "odio"
    };
    ...
    public void start() throws TwitterException {
        ...
        LOGGER.info("Starting mock filtering twitter streams for keywors{}", Arrays.toString(keywords));
    ...
    private void sleep(long sleepTimeMS) {
        try {
            ...
            throw new TwitterToKafkaServiceException("Error while sleeping for waiting a new status to be created!!");
        }
    }
