package com.microservices.main.elastic.index.client.service.impl;
...
import com.microservices.main.elastic.index.client.util.ElasticIndexUtil;
...
@Service
@ConditionalOnProperty(name = "elastic-config-data.is-repository", havingValue = "false")
public class TwitterElasticIndexClient implements ElasticIndexClient<TwitterIndexModel> {
    ...
    public List<String> save(List<TwitterIndexModel> documents) {
        ...
        LOGGER.info("Documents indexed successfully with type: {} and ids: {}", TwitterIndexModel.class.getName(), documentIds);
        return documentIds;
    }
}
